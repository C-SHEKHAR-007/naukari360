...
// Content Security Policy - permissive enough for ads but still protective
const cspDirectives = [
  "default-src 'self'",
  ...
  "img-src 'self' data: blob: https://res.cloudinary.com https://lh3.googleusercontent.com https://*.googleusercontent.com https://www.google-analytics.com https://www.googletagmanager.com https://pagead2.googlesyndication.com",
  "font-src 'self' data:",
